...
def deeplabv3_mobilenet_v3_large(num_classes=19, pretrained=True):
    ...
    if pretrained:
        model.load_state_dict(DeepLabV3_MobileNet_V3_Large_Weights.COCO_WITH_VOC_LABELS_V1.get_state_dict(progress=True), strict=False)
